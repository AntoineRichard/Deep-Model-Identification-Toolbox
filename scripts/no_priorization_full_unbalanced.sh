...
to_file="$output_root/no_priorization_full_unbalanced.txt"
save_suffix="$output_root/results/GS/STD_full_unbalanced"
tb_suffix="$output_root/tensorboard/GS/STD_full_unbalanced"
