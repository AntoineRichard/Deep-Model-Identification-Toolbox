...
trainsteps=("320000" "160000" "80000" "40000" "20000" "10000" "5000" "2500" "1250")
...
to_file="$output_root/gridsearch_batchsize.txt"
save_suffix="$output_root/results/GS/BatchSizeSearch"
tb_suffix="$output_root/tensorboard/GS/BatchSizeSearch"
...
do
	...
	do
		...
		for (( k=0; k<${#trainsteps[*]}; k++ ))
		do
			steps=${trainsteps[k]}
			batch_size=${batchsizes[k]}
