...
to_file="$output_root/no_priorization_most_unbalanced.txt"
save_suffix="$output_root/results/GS/STD_most_unbalanced"
tb_suffix="$output_root/tensorboard/GS/STD_most_unbalanced"
