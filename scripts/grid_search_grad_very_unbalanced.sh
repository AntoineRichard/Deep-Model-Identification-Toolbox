...
to_file="$output_root/gridsearch_grad_very_unbalanced.txt"
save_suffix="$output_root/results/GS/GRAD_very_unbalanced"
tb_suffix="$output_root/tensorboard/GS/GRAD_very_unbalanced"
