...
to_file="$output_root/gridsearch_grad_unbalanced.txt"
save_suffix="$output_root/results/GS/GRAD_unbalanced"
tb_suffix="$output_root/tensorboard/GS/GRAD_unbalanced"
