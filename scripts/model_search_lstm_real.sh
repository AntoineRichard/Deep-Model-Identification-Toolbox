# MODEL SEARCH
network_list="/cs-share/dream/systemid_v2/scripts/network_list/LSTM_networks_LRELU_real.txt"
...
to_file="$output_root/model_search_lstm_real.txt"
save_suffix="$output_root/results/GS/LSTM_real"
tb_suffix="$output_root/tensorboard/GS/LSTM_real"
