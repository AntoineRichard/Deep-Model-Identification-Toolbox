...
to_file="$output_root/no_priorization_full_random.txt"
save_suffix="$output_root/results/GS/STD_full_random"
tb_suffix="$output_root/tensorboard/GS/STD_full_random"
