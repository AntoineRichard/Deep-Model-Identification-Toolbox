# MODEL SEARCH
network_list=$(cat "/cs-share/dream/systemid_v2/scripts/network_list/RNN_networks_LRELU.txt")
...
to_file="$output_root/model_search_rnn_full_random.txt"
save_suffix="$output_root/results/GS/RNN_full_random"
tb_suffix="$output_root/tensorboard/GS/RNN_full_random"
