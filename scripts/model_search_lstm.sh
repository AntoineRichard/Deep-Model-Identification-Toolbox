...
to_file="$output_root/model_search_lstm_full_random.txt"
save_suffix="$output_root/results/GS/LSTM_full_random"
tb_suffix="$output_root/tensorboard/GS/LSTM_full_random"
