...
to_file="$output_root/gridsearch_grad_full_random.txt"
save_suffix="$output_root/results/GS/GRAD_full_random"
tb_suffix="$output_root/tensorboard/GS/GRAD_full_random"
