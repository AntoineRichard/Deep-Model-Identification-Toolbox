...
to_file="$output_root/gridsearch_per_full_unbalanced.txt"
save_suffix="$output_root/results/GS/PER_full_unbalanced"
tb_suffix="$output_root/tensorboard/GS/PER_full_unbalanced"
