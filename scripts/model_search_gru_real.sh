# MODEL SEARCH
network_list="/cs-share/dream/systemid_v2/scripts/network_list/GRU_networks_LRELU_real.txt"
...
to_file="$output_root/model_search_gru_real.txt"
save_suffix="$output_root/results/GS/GRU_real"
tb_suffix="$output_root/tensorboard/GS/GRU_real"
